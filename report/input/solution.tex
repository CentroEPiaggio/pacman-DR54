...
\label{sec:scenario}
\todo[]{Please complete this with some technical specs of Vito. I'm sure you have already something written that you can basically copy and paste.}
Our scenario is composed by a humanoid robot equipped with

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Object Segmentation}
\label{sec:segmentation}
\todo[inline]{why do we review previous work on object segmentation here? should it be done in the related work section?}
...
%% Don't we have said enough about it in section 3?
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
