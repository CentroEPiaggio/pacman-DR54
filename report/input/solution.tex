...
Figure~\ref{fig:GPAtlasRRTtwo}~and~\ref{fig:GPAtlasRRTfunnel} shows the Atlas RRT expanding on various implict surfaces and finding the next-best tactile action to perform.
