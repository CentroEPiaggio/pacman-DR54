...
\todo[inline]{F: somehow i should figure out how to describe omega params, somewhere...}
...
\todo[inline]{Should probably mention bias RRTs.}
...
$\mathcal{C}_k$ is then tested for the termination condition and the whole process
starts anew.
\todo[inline]{mention what is the termination condition}
...
\todo{this last paragraph does not match with the rest, should fix it or remove it}
