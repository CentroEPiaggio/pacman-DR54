...
random point 
$$
\mathbf{x}_{c,i} \in \chi
$$
where $\chi$ is the object training set,
...
\todo[inline, author=Federico]{Should probably mention bias RRTs and say that this is not
    exactly a planner, because there is no goal, just exploration}
...
$$
\todo{these needs math rewording}
...
\todo{this period does not match with the rest}
