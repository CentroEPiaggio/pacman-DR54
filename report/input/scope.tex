...
f(\mathbf{x}_j) = 0
\\ 
\boldsymbol{\Phi}^\top( \mathbf{x}_j - \mathbf{x}_j^i )
\end{matrix}\right.,
\end{equation}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Equipment specification and scope}
